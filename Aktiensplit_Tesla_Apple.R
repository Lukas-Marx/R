...
png("AAPL_Vol.png", width = 3840, height = 2160)
plot(Aktie.volume1, xlab="gesamter Zeitraum", ylab='Volume AAPL (black)', col="black")
abline(v=as.Date(Subsequence2.Start), lty=2, col="green")
...
legend("topleft", legend = c("EV", "SD"), col = c("blue","blue","green"), lty = 1:2,cex = 0.6)
dev.off()

png("TSLA_Vol.png", width = 3840, height = 2160)
...
png("AAPL_Vol_with_subsequence.png", width = 3840, height = 2160)
plot(Aktie.volume1, xlab="gesamter Zeitraum", ylab='Volume AAPL (black)', col="black")
abline(v=as.Date(Subsequence2.Start), lty=2, col="green")
...
legend("topleft", legend = c("EV_pre", "SD_pre","EV_post","SD_post"), col = c("blue","blue","red","red","green"), lty = 1:2,cex = 0.6)
dev.off()

png("TSLA_Vol_with_subsequence.png", width = 3840, height = 2160)
plot(Aktie.volume2, xlab="gesamter Zeitraum", ylab='Volume TSLA (black)', col="black")
abline(v=as.Date(Subsequence2.Start), lty=2, col="green")
...
png("AAPL_Adj.png", width = 3840, height = 2160)
...
png("TSLA_Adj.png", width = 3840, height = 2160)
...
png("AAPL_Adj_with_subsequence.png", width = 3840, height = 2160)
plot(Aktie.Adjusted1, xlab="gesamter Zeitraum", ylab='Adjusted Stock AAPL (black)', col="black")
abline(v=as.Date(Subsequence2.Start), lty=2, col="green")
...
png("TSLA_Adj_with_subsequence.png", width = 3840, height = 2160)
plot(Aktie.Adjusted2, xlab="gesamter Zeitraum", ylab='Adjusted Stock TSLA (black)', col="black")
abline(v=as.Date(Subsequence2.Start), lty=2, col="green")
